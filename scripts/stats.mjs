...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "venomcowork-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "venom-cowork/workspace"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "venomcowork-download-stats",
  }
