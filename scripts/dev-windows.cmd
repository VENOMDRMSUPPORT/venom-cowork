...
if not defined VSDEVCMD (
  echo [venomcowork] Could not find VsDevCmd.bat. Install Visual Studio Build Tools with Desktop development with C++.
  exit /b 1
)
...
if /I "%TARGET_ARCH%"=="x64" (
  call corepack pnpm --filter @venom-cowork/desktop dev:windows:x64
) else (
  call corepack pnpm --filter @venom-cowork/desktop dev:windows
)
