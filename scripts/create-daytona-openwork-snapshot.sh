...
SNAPSHOT_NAME="${1:-${DAYTONA_SNAPSHOT_NAME:-venomcowork-runtime}}"
...
LOCAL_IMAGE_TAG="${DAYTONA_LOCAL_IMAGE_TAG:-venomcowork-daytona-snapshot:${SNAPSHOT_NAME//[^a-zA-Z0-9_.-]/-}}"
...
echo "- venomcowork-orchestrator@$VENOMCOWORK_ORCHESTRATOR_VERSION" >&2
