...
Add self-serve SCIM to `ee/apps/den-api` so an organization in VenomCowork Cloud can:
...
For VenomCowork Cloud, the safer stance is:
...
- closer to VenomCowork's org model
...
1. Are VenomCowork identities allowed to be globally shared across orgs when SCIM emails match?
