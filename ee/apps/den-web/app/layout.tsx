...
export const metadata: Metadata = {
  metadataBase: new URL("https://app.venomcowork.local"),
  title: "VenomCowork Cloud",
  description:
    "Share your VenomCowork setup with your team, manage billing, and use VenomCowork Cloud from app.venomcowork.local.",
  openGraph: {
    title: "VenomCowork Cloud",
    description:
      "Share your VenomCowork setup with your team and keep selected workflows available in VenomCowork Cloud.",
  ...
  twitter: {
    ...
    title: "VenomCowork Cloud",
    description:
      "Share your VenomCowork setup with your team and manage VenomCowork Cloud from app.venomcowork.local.",
    images: ["/opengraph-image"]
  },
  icons: {
    icon: "/venomcowork-mark.svg"
  }
};
