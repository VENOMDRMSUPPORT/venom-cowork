          ...
          <div className="den-frame relative min-h-[210px] overflow-hidden px-5 py-6 sm:min-h-[260px] sm:px-7 sm:py-8 md:px-10 md:py-10 lg:min-h-[300px]">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between gap-10">
              <div className="flex items-center gap-3">
                <img src="/venomcowork-logo-transparent.svg" alt="VenomCowork" className="h-9 w-auto" />
                <span className="text-[13px] font-medium text-white/80">VenomCowork Cloud</span>
              </div>
