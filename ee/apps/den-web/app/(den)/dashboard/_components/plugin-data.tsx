...
/**
 * Plugin primitives â€” mirror OpenCode / Claude Code's plugin surface:
 *
...
// â”€â”€ Primitive types â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export type DenPlugin = {
   ...
   * - "any"      â†’ visible once ANY integration is connected (e.g. marketplace output styles)
   * - "github"   â†’ only visible after a GitHub account is connected
   * - "bitbucket"â†’ only visible after a Bitbucket account is connected
   */
...
export function getPluginPartsSummary(plugin: DenPlugin): string {
  ...
  return parts.length > 0 ? parts.join(" Â· ") : "Empty bundle";
}
...
const MOCK_PLUGINS: DenPlugin[] = [
    ...
    mcps: [
      {
        id: "mcp_gh",
        name: "github-mcp",
        description: "Official GitHub MCP server â€” issues, PRs, releases, Actions.",
        transport: "http",
        toolCount: 42,
      },
    ],
    ...
    mcps: [
      {
        id: "mcp_linear",
        name: "linear-mcp",
        description: "Linear MCP â€” issues, cycles, projects, comments.",
        transport: "http",
        toolCount: 24,
      },
    ],
  ...
  {
    id: "plg_venomcowork_release",
    name: "VenomCowork Release Kit",
    slug: "venomcowork-release-kit",
    description:
      "Internal plugin that automates VenomCowork release prep, orchestrator sidecar builds, and changelog generation. Shipped by VenomCowork infra.",
    version: "2.3.1",
    author: "VenomCowork",
    category: "workflows",
    installed: true,
    source: { type: "github", repo: "venom-cowork/workspace-plugins" },
    skills: [
    ...
    mcps: [
      {
        id: "mcp_sentry",
        name: "sentry-mcp",
        description: "Sentry MCP â€” projects, issues, releases, performance.",
        transport: "http",
        toolCount: 18,
      },
    ],
...
// â”€â”€ Query hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
//
