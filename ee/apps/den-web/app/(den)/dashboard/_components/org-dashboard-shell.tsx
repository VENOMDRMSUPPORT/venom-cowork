...
const VENOMCOWORK_DOCS_URL = "https://venomcowork.local/docs";
...
function VenomCoworkMark({ className = "h-9 w-auto" }: { className?: string }) {
  return (
    <svg
...
export function OrgDashboardShell({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    ...(access.isAdmin
      ? [
          // NOTE: Shared Workspace soft-disabled â€” uncomment to re-enable
          // {
          ...
          // NOTE: Skill Hubs soft-disabled â€” uncomment to re-enable
          // {
    ...
    <div className="relative">
      ...
      >
        <div className="flex min-w-0 items-center gap-3">
          <OrgMark name={activeOrg?.name ?? "VenomCowork"} />
                ...
                <div className="flex min-w-0 items-center gap-2.5">
                  <div className="min-w-0">
                    ...
                    <span className="block truncate text-[12px] text-gray-500">
                      {org.role === "owner" ? "Creator plan" : "Free plan"} â€¢ {org.memberCount} {org.memberCount === 1 ? "member" : "members"}
                    </span>
                  </div>
                </div>
                {org.isActive ? (
  ...
  const sidebarContent = (
    <div className="flex flex-1 flex-col">
      ...
      <div className="mt-auto p-3">
        ...
        {orgBusy ? (
          <p className="mt-3 px-2 text-[11px] text-gray-400">Refreshing workspaceâ€¦</p>
        ) : null}
        {orgError ? (
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#fafafa] md:flex-row">
      ...
      {/* Mobile sidebar â€” off-canvas drawer */}
      {sidebarOpen ? (
