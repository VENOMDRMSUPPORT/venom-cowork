...
function getProviderSourceLabel(source: DenLlmProviderSource) {
  if (source === "venomcowork") return "VenomCowork";
        ...
        {venomCoworkKeyRows.length > 0 ? (
          <section className="overflow-hidden rounded-[28px] border border-gray-200 bg-white">
            <div className="border-b border-gray-100 px-6 py-4">
              ...
              <p className="mt-1 text-[13px] text-gray-500">Members in this organization with an VenomCowork Models key.</p>
            </div>
              ...
              >
                ...
                <div className="mt-6 grid gap-3 rounded-[24px] bg-gray-50 p-4 text-[13px] text-gray-600 sm:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-1">{memberAccessCount} people Â· {teamAccessCount} teams</p>
                  </div>
                  <div>
