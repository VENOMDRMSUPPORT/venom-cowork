...
const VENOMCOWORK_MCP_DOCS = "https://github.com/venom-cowork/workspace/blob/dev/docs/mcp-ui-control-profile.md";
...
export function MarketplaceOnboardingScreen() {
  ...
  return (
    <div className="mx-auto max-w-[1120px] px-3 pb-8 pt-3 sm:px-6 sm:pb-10 sm:pt-4 md:px-8">
      ...
      {/* â”€â”€ Mobile: stepped onboarding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
              ...
              <div className="flex flex-1 flex-col justify-between p-5">
                ...
                <div className="mt-5 rounded-[18px] border border-white/10 bg-white/[0.06] p-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <p className="text-[13px] font-semibold">VenomCowork Models</p>
                  </div>
              ...
              <div className="flex flex-1 flex-col justify-between p-5">
                ...
                <div className="mt-5 space-y-3">
                  ...
                  <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] leading-5 text-[#526582]">
                      Ask any AI app to package and distribute plugins through VenomCowork.
                    </p>
                    <pre className="mt-2 rounded-lg bg-[#07192C] px-3 py-2 text-[11px] text-cyan-100"><code>npx venomcowork-ui-mcp</code></pre>
                  </div>
                </div>
      ...
      {/* â”€â”€ Desktop/tablet: full onboarding layout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className="hidden sm:block">
        ...
        <section className="overflow-hidden rounded-[28px] border border-[#dfe5f0] bg-[#07192C] text-white shadow-sm">
          <div className="grid gap-6 p-6 md:grid-cols-[1.3fr_0.7fr] md:p-10">
            <div>
              <p className="text-[12px] font-semibold uppercase tracking-[0.26em] text-cyan-200">VenomCowork Cloud</p>
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-center md:gap-8">
            <div>
              <div className="flex items-center gap-2">
                ...
                <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-[#41618F]">VenomCowork Models</p>
              </div>
            ...
            <div className="flex flex-row gap-2 md:flex-col">
              <Link href="/dashboard/inference" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#07192C] px-5 py-2.5 text-[13px] font-semibold text-white shadow-[0_14px_32px_-20px_rgba(1,22,39,0.45)] transition hover:bg-black">
                <Zap className="h-4 w-4" /> Enable VenomCowork Models
              </Link>
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-2">
          {(isLoading ? [] : marketplaces).map((marketplace) => {
            const isVenomCowork = marketplace.name === "VenomCowork Marketplace";
            const description = isVenomCowork
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-baseline justify-between gap-2">
                      <h2 className="truncate text-[16px] font-semibold tracking-[-0.02em] text-[#07192C]">{isVenomCowork ? "VenomCowork Marketplace" : "Community Plugins"}</h2>
        ...
        <section className="mt-6 grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-[22px] border border-[#d7e2f5] bg-[#F4F8FF] p-6 shadow-sm">
            ...
            <h2 className="mt-2 text-[18px] font-semibold tracking-[-0.03em] text-[#07192C]">VenomCowork MCP</h2>
            <p className="mt-2 text-[13px] leading-6 text-[#526582]">
              Add the MCP server to Claude, Cursor, or any app that supports MCP.
            </p>
            <pre className="mt-3 overflow-x-auto rounded-xl bg-[#07192C] px-4 py-3 text-[12px] leading-6 text-cyan-100"><code>npx venomcowork-ui-mcp</code></pre>
            <a href={VENOMCOWORK_MCP_DOCS} target="_blank" rel="noreferrer" className="mt-3 inline-flex items-center gap-2 text-[13px] font-semibold text-[#164B8F] transition hover:text-[#0F376C]">
