...
export const INTEGRATION_PROVIDERS: Record<IntegrationProvider, IntegrationProviderMeta> = {
  github: {
    provider: "github",
    name: "GitHub",
    description: "Install the VenomCowork GitHub App, then pick a repository to turn into a connector instance.",
...
export function getMockAccountsFor(provider: IntegrationProvider): IntegrationAccount[] {
  if (provider === "github") {
    return [
      ...
      { id: "acc_gh_venomcowork", name: "venomcowork-labs", kind: "org", avatarInitial: "O" },
    ];
  }
  return [
    { id: "acc_bb_user", name: "bshafii", kind: "user", avatarInitial: "B" },
    { id: "acc_bb_venomcowork", name: "venomcowork", kind: "org", avatarInitial: "O" },
  ];
}
  ...
  const base: IntegrationRepo[] = [
    {
      id: `${tag}:venomcowork`,
      name: "venomcowork",
      fullName: `${accountToLabel(accountId)}/venomcowork`,
      description: "Core VenomCowork monorepo â€” desktop, server, and orchestrator.",
      hasPlugins: true,
    },
    {
      id: `${tag}:venomcowork-plugins`,
      name: "venomcowork-plugins",
      fullName: `${accountToLabel(accountId)}/venomcowork-plugins`,
...
function accountToLabel(accountId: string): string {
  if (accountId.includes("venomcowork-labs")) return "venomcowork-labs";
  if (accountId.includes("venomcowork")) return "venomcowork";
