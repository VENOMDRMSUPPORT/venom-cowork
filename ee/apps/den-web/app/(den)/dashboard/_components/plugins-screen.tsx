...
export function PluginsScreen() {
  ...
  return (
    <DashboardPageTemplate
      ...
      badgeLabel="Preview"
      title="Plugins"
      description="Discover and manage plugins â€” bundles of skills, hooks, MCP servers, agents, and commands that extend your workers."
      ...
      {isLoading || integrationsLoading ? (
        ...
        <PrimitiveList
          ...
          rows={filteredMcps.map((mcp) => ({
            ...
            meta: `${mcp.transport} Â· ${mcp.toolCount} tool${mcp.toolCount === 1 ? "" : "s"}`,
