              ...
              {formMode === "saml" ? (
                <>
                  ...
                  <label className="block text-[14px] text-gray-700 md:col-span-2">
                    ...
                    <input className="w-full rounded-[18px] border border-gray-200 px-4 py-3" value={audience} onChange={(event) => setAudience(event.target.value)} placeholder="Defaults to the VenomCowork auth URL" />
                  </label>
                  <label className="block text-[14px] text-gray-700 md:col-span-2">
              ...
              <div className="mt-5 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-[20px] border border-gray-200 bg-gray-50 p-4 text-[14px] text-gray-700">
                    ...
                    <p className="mt-2">{connection.kind.toUpperCase()} Â· {connection.domain}</p>
