# VenomCowork Model Catalog

This directory is the static publish root for the generated VenomCowork model catalog.
...
The generated `models/api.json` file is ignored by git. It is rebuilt from `src/models/base.json` and the active VenomCowork overlay by `scripts/build-models.mjs`.
