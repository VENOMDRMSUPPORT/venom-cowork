...
function seedRequiredEnv() {
  process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/venomcowork_test"
...
// A chainable Drizzle-like query stub whose terminal awaited value is [] â€”
