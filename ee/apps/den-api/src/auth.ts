...
import * as schema from "@venom-cowork-ee/den-db/schema";
...
export const DEN_MCP_TOKEN_USE_CLAIM = "https://venomcowork.local/token_use";
export const DEN_MCP_ORG_ID_CLAIM = "https://venomcowork.local/org_id";
export const DEN_MCP_RESOURCE_CLAIM = "https://venomcowork.local/resource";
