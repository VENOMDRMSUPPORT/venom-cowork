...
import { and, eq, isNotNull, isNull } from "@venom-cowork-ee/den-db/drizzle"
import { AuthAccountTable, AuthUserTable, ExternalIdentityTable, MemberTable, ScimProviderTable } from "@venom-cowork-ee/den-db/schema"
...
export function buildOrganizationScimProviderId(organizationId: OrganizationId) {
  return `venomcowork-scim-${organizationId}`
}
