...
import { AuthAccountTable, ExternalIdentityTable, SsoConnectionTable, SsoProviderTable } from "@venom-cowork-ee/den-db/schema"
...
export function buildOrganizationSsoProviderId(organizationId: OrganizationId) {
  return `venomcowork-sso-${organizationId}`
}
