  ...
  app.use(
    "*",
      cors({
        ...
        credentials: true,
        allowHeaders: ["Content-Type", "Authorization", "X-Api-Key", "X-Request-Id", "X-VenomCowork-Legacy-Org-Id"],
...
app.get(
  ...
  describeRoute({
    ...
    description: "Redirects the API root to the VenomCowork marketing site instead of serving API content.",
    responses: {
      302: emptyResponse("Redirect to the VenomCowork marketing site."),
    },
  }),
  (c) => {
    return c.redirect("https://venomcowork.local", 302)
  },
)
...
app.get(
  ...
  openAPIRouteHandler(app, {
    documentation: {
      ...
      servers: [
        { url: "https://api.venomcowork.local" },
      ],
      tags: [
