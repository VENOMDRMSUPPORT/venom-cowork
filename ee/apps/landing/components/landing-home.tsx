        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-16 px-6 pb-24 md:gap-20 md:px-8 md:pb-28">
          <section className="max-w-4xl pt-8 md:pt-12">
            ...
            <p className="mb-6 max-w-4xl text-lg leading-relaxed text-gray-700 md:mb-7 md:text-xl">
              VenomCowork is the desktop app that lets you use 50+ LLMs, bring your
          ...
          {props.isMobileVisitor ? (
            ...
            >
              ...
              <p className="mb-5 text-[15px] leading-7 text-gray-600">
                VenomCowork is a desktop app. Sign up here from your phone and keep the
                    ...
                    >
                        <div className="flex w-full max-w-lg flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                          ...
                          <div className="flex items-center gap-3 border-b border-gray-100 bg-gray-50/80 px-4 py-2.5">
                            ...
                            <div className="text-[12px] font-medium text-gray-500">VenomCowork</div>
                          </div>
                              ...
                              <div className="flex flex-1 flex-col gap-4 p-4">
                                ...
                                <div className="flex flex-col gap-1 pl-1">
                                  <div className="flex items-center gap-1.5 text-[10px] text-gray-400">
                                    <span className="text-gray-300">&rsaquo;</span> Execution 1 step â€” Queried HubSpot MCP for deal history
                                  </div>
                                  <div className="flex items-center gap-1.5 text-[10px] text-gray-400">
                                    <span className="text-gray-300">&rsaquo;</span> Execution 2 steps â€” Pulled Notion meeting notes
                                  </div>
                                  <div className="flex items-center gap-1.5 text-[10px] text-gray-400">
                                    <span className="text-gray-300">&rsaquo;</span> Execution 1 step â€” Generated brief and saved to desktop
                                  </div>
                                </div>
