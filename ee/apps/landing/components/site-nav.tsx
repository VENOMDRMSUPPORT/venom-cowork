...
export function SiteNav(props: Props) {
  ...
  const cloudSignupHref = "https://app.venomcowork.local?mode=sign-up";
  ...
  const navItems = [
    ...
    { href: "https://app.venomcowork.local", label: "Cloud", key: "cloud" },
    ...
    <header className={`sticky top-0 z-20 w-full transition-all duration-300 ${scrolled ? "bg-white/80 shadow-sm backdrop-blur-md" : ""}`}>
      <div className="mx-auto flex max-w-5xl flex-col px-6 md:px-8">
        <div className="grid grid-cols-[auto_1fr_auto] items-center py-4">
          ...
          >
            <VenomCoworkMark className="h-[30px] w-[38px] transition-opacity group-hover:opacity-80" />
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://github.com/venom-cowork/workspace"
              ...
              rel="noreferrer"
              target="_blank"
              aria-label="VenomCowork GitHub stars"
            >
              <svg
                className="h-4 w-4"
                fill="currentColor"
