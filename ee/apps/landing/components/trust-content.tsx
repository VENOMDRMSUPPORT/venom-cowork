...
/* ------------------------------------------------------------------ */
/*  Key facts â€” the at-a-glance grid at the top of the page           */
/* ------------------------------------------------------------------ */
...
export const keyFacts: KeyFact[] = [
  ...
  },
  {
    label: "Incident SLA",
    value: "72hr notify",
    detail: "3-day ack Â· 7-day triage",
    icon: Clock
  },
  {
    label: "Subprocessors",
...
export const dataHandlingRows: DataHandlingRow[] = [
  {
    ...
    cloud: "Not stored by VenomCowork. Accessed at runtime through your LLM provider."
  },
  {
    dataType: "LLM API keys",
    selfHosted: "Local keychain or environment variables",
    cloud: "Held by your LLM provider, not by VenomCowork"
  },
  {
    dataType: "Prompts & responses",
    selfHosted: "Local only",
    cloud: "Sent to your LLM provider. Not logged by VenomCowork."
  },
  {
...
export const securityContact = {
  name: "Omar McAdam",
  email: "team+security@venomcowork.local"
};
