...
import { VenomCoworkMark } from "./venomcowork-mark";
...
const powerUsers: PowerUser[] = [
  ...
  },
  {
    ...
    trendNote: "Early-adopter curve â€” curiosity cooling off",
    requests: "960",
    inputTokens: "540K",
    outputTokens: "210K",
    cost: "$780"
  },
  {
    ...
    trendNote: "Scheduled automation â€” same batch every day",
    requests: "880",
    inputTokens: "500K",
    outputTokens: "200K",
    cost: "$690"
  },
  {
    ...
    trendNote: "Learning curve â€” compounding every week",
    requests: "680",
    inputTokens: "380K",
    outputTokens: "170K",
    cost: "$520"
  },
  {
    ...
    trendNote: "Late adopter â€” just caught the wave",
    requests: "510",
    inputTokens: "290K",
    outputTokens: "140K",
    cost: "$420"
      ...
      <div className="relative border-t border-[#e7e9f0] px-4 pb-5 pt-3 sm:px-6 md:px-8 md:pb-6 md:pt-4">
        ...
        <div className="relative z-10 mt-4 grid gap-3 md:grid-cols-3 md:gap-3.5">
          ...
          <StatCard
            ...
            value="41%"
            subvalue="VenomCowork Â· 54 users"
            tone="blue"
          />
        </div>
  ...
  return (
    <div className="relative z-10 flex flex-wrap items-center justify-between gap-3 border-b border-[#e7e9f0] pb-3">
      <div className="flex flex-wrap items-center gap-2.5 md:gap-3">
        <VenomCoworkMark className="h-[24px] w-[30px] md:h-[26px] md:w-[33px]" />
        ...
        >
          ...
          <div>
            <Sparkline
              ...
              title={`${user.trendNote} â€” cumulative ${user.trend[0].toLocaleString()} \u2192 ${user.trend[user.trend.length - 1].toLocaleString()} over 10 weekdays`}
            />
          </div>
...
function ToolGlyph({ tool, small = false }: { tool: string; small?: boolean }) {
  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    "Hugging Face": <span className={small ? "text-[11px]" : "text-[13px] md:text-[14px]"}>ðŸ¤—</span>,
