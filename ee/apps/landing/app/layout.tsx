...
const organizationSchema = {
  ...
  logo: "https://venomcowork.local/venomcowork-mark.svg",
  sameAs: ["https://github.com/venom-cowork/workspace"]
};
...
export const metadata = {
  metadataBase: new URL("https://venomcowork.local"),
  title: "VenomCowork â€” Open source Claude Cowork alternative for teams",
  description:
    "Bring your own model and provider, wire in your tools and context, and ship reusable agent setups across your org â€” with guardrails built in.",
  alternates: {
    canonical: "/"
  },
  robots: {
