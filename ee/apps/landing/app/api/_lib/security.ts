...
const defaultAllowedOrigins = [
  "https://venomcowork.local",
  "https://www.venomcowork.local",
  "https://venomcowork.software",
  "https://www.venomcowork.software",
  "http://localhost:3000",
  "http://127.0.0.1:3000",
  "http://localhost:3005",
  "http://127.0.0.1:3005",
...
const store = globalThis as typeof globalThis & {
  __venomcoworkLandingRateLimitStore?: Map<string, FixedWindowEntry>;
};

const rateLimitStore = store.__venomcoworkLandingRateLimitStore ?? new Map<string, FixedWindowEntry>();
store.__venomcoworkLandingRateLimitStore = rateLimitStore;
