...
import { VenomCoworkMark } from "../../components/venomcowork-mark";
import { SiteFooter } from "../../components/site-footer";
import { baseOpenGraph } from "../../lib/seo";

export const metadata = {
  title: "VenomCowork â€” Feedback",
  description: "Send app feedback to the VenomCowork team with prefilled runtime context.",
  alternates: {
    canonical: "/feedback"
  },
  robots: {
  ...
  openGraph: {
    ...baseOpenGraph,
    url: "https://venomcowork.local/feedback"
  }
};
...
export default function FeedbackPage({ searchParams }: PageProps) {
  const prefill: AppFeedbackPrefill = {
    source: readSearchParam(searchParams, "source") || "venomcowork-app",
    ...
    venomcoworkServerVersion: readSearchParam(searchParams, "venomcoworkServerVersion"),
      ...
      <div className="mx-auto max-w-5xl px-6 pb-20 pt-6 md:px-8 md:pt-8">
        <header className="mb-10 flex items-center justify-between gap-4">
          <Link href="/" className="inline-flex items-center gap-3 text-[#011627]">
            <VenomCoworkMark className="h-[30px] w-[38px]" />
