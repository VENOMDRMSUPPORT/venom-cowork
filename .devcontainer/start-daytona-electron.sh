...
cd "${VENOMCOWORK_WORKSPACE_DIR:-/workspace}"
...
subprocess.Popen(
    ...
    cwd=os.environ.get("VENOMCOWORK_WORKSPACE_DIR", "/workspace"),
    env=os.environ.copy(),
...
export VENOMCOWORK_ELECTRON_FAKE_MEDIA="${VENOMCOWORK_ELECTRON_FAKE_MEDIA:-0}"

exec pnpm --filter @venom-cowork/desktop dev:electron
