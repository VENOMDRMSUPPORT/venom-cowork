...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/venom-cowork/workspace.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.venomcowork/opencode-router/venomcowork}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.venomcowork/opencode-router/venomcowork)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/venom-cowork/workspace.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/venom-cowork/workspace/dev/apps/opencode-router/install.sh | bash
EOF
}
