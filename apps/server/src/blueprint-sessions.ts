...
export function normalizeBlueprintSessionTemplates(venomcowork: Record<string, unknown> | null | undefined): BlueprintSessionTemplate[] {
  const blueprint = readRecord(venomcowork?.blueprint);
...
export function readMaterializedBlueprintSessions(venomcowork: Record<string, unknown> | null | undefined): MaterializedBlueprintSession[] {
  const blueprint = readRecord(venomcowork?.blueprint);
...
export function applyMaterializedBlueprintSessions(
  venomcowork: Record<string, unknown> | null | undefined,
