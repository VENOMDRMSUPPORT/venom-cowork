...
const binaryName = process.platform === "win32" ? "venomcowork-server.exe" : "venomcowork-server";
...
console.error(
  `Unable to find an VenomCowork server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
