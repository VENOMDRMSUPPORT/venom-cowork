...
const compiledBinaryName = process.platform === "win32" ? "venomcowork-router.exe" : "venomcowork-router";
...
console.error(
  `Unable to find an venomcowork-router entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
