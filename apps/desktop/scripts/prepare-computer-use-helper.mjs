...
const helperAppName = "VenomCowork Computer Use.app";
const bundleIdentifier = "com.venom.cowork.computer-use";
...
const force = hasFlag("--force") || process.env.VENOMCOWORK_COMPUTER_USE_FORCE_BUILD === "1";
...
<dict>
  ...
  <string>VenomCowork Computer Use</string>
