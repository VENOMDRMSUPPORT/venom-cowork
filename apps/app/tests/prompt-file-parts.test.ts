...
describe("first-line local file parts", () => {
  test("detects tilde paths in the first line", () => {
    const parts = firstLineLocalFileParts(
      "check ~/code/research/venomcowork-users/list.csv\nits a list of unique email domains",
      "/Users/omar/code/venomcowork",
    );
    ...
    expect(parts).toEqual([
      {
        type: "file",
        mime: "text/plain",
        url: "file:///Users/omar/code/research/venomcowork-users/list.csv",
        filename: "list.csv",
      },
    ]);
  });
  ...
  test("only detects paths from the first line", () => {
    const parts = firstLineLocalFileParts(
      "summarize this\n~/code/research/venomcowork-users/list.csv",
      "/Users/omar/code/venomcowork",
    );
  ...
  test("detects Windows absolute paths in the first line", () => {
    expect(firstLineLocalFileParts("check C:\\Users\\omar\\list.csv", "C:/Users/omar/code/venomcowork")).toEqual([
      {
        type: "file",
        mime: "text/plain",
...
describe("slash-command parsing", () => {
  ...
  test("does not parse absolute file paths as commands", () => {
    expect(parseSlashCommandInvocation("/Users/omar/code/venomcowork/apps/app/src/file.ts\nwhy does this fail?")).toBeNull();
