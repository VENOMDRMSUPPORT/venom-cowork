...
const starterRoot = "/Users/test/VenomCowork/starter";
const otherRoot = "/Users/test/VenomCowork/second";
...
try {
  ...
  step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\VenomCowork\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\VenomCowork\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\VenomCowork\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/venomcowork/starter");
  });
  ...
  step("round-trip invariant: every query path equals the create path (unix)", () => {
    ...
    const unixPaths = [
      "/Users/test/VenomCowork/starter",
      "/Users/test/VenomCowork/starter/",
  ...
  step("round-trip invariant: every query path equals the create path (windows)", () => {
    ...
    // Use escaped strings â€” Bun's parser chokes on String.raw inside array literals.
    const windowsPaths = [
      "C:\\Users\\Test\\VenomCowork\\starter",
      "C:\\Users\\Test\\VenomCowork\\starter\\",
      "D:\\projects\\my-app",
