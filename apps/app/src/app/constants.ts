...
import {
  BUILT_IN_VENOMCOWORK_EXTENSION_MANIFESTS,
  extensionContribution,
  extensionResource,
  isTrustedBuiltInExtension,
  type VenomCoworkExtensionManifest,
} from "./extensions";

export const MODEL_PREF_KEY = "venomcowork.defaultModel";
export const SESSION_MODEL_PREF_KEY = "venomcowork.sessionModels";
export const THINKING_PREF_KEY = "venomcowork.showThinking";
export const VARIANT_PREF_KEY = "venomcowork.modelVariant";
export const LANGUAGE_PREF_KEY = "venomcowork.language";
export const HIDE_TITLEBAR_PREF_KEY = "venomcowork.hideTitlebar";
...
export type McpDirectoryInfo = {
  ...
  /** Whether VenomCowork should show this extension as enabled before user setup. */
  defaultEnabled?: boolean;
  /** Whether VenomCowork should hide this extension from the default catalog view. */
  defaultHidden?: boolean;
  /** Whether this extension is still in preview. */
  preview?: boolean;
  /** Normalized extension manifest backing this catalog entry. */
  extensionManifest?: VenomCoworkExtensionManifest;
};

function extensionManifestToDirectoryInfo(manifest: VenomCoworkExtensionManifest): McpDirectoryInfo {
...
export function isBuiltInVenomCoworkExtension(entry: Pick<McpDirectoryInfo, "kind" | "extensionManifest">): boolean {
...
export const MCP_QUICK_CONNECT: McpDirectoryInfo[] = [
  ...
  {
    get name() { return t("mcp.quick_connect_venomcowork_cloud_title"); },
    serverName: "venomcowork-cloud",
    get description() { return t("mcp.quick_connect_venomcowork_cloud_desc"); },
    get url() {
      try {
    ...
    oauth: true,
    kind: "mcp",
    iconSrc: "/venomcowork-mark.svg",
  },
  {
    get name() { return t("mcp.quick_connect_venomcowork_ui_title"); },
    serverName: "venomcowork-ui",
    get description() { return t("mcp.quick_connect_venomcowork_ui_desc"); },
    type: "local",
  ...
  ...BUILT_IN_VENOMCOWORK_EXTENSION_MANIFESTS.map(extensionManifestToDirectoryInfo),
];

export const VENOMCOWORK_EXTENSION_CATALOG = MCP_QUICK_CONNECT.filter((entry) => entry.kind === "extension");
