...
const THEME_PREF_KEY = "venomcowork.react.settings.theme-mode";
const LEGACY_THEME_PREF_KEYS = ["venomcowork.themePref"];
...
const syncNativeTheme = (mode: ThemeMode) => {
  ...
  void window.__VENOMCOWORK_ELECTRON__?.invokeDesktop?.("__setNativeTheme", mode);
};
