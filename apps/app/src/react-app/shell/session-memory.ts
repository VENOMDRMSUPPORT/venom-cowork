...
const ACTIVE_WORKSPACE_KEY = "venomcowork.react.activeWorkspace";
const SESSION_BY_WORKSPACE_KEY = "venomcowork.react.sessionByWorkspace";
const WORKSPACE_ORDER_KEY = "venomcowork.react.workspaceOrder";
