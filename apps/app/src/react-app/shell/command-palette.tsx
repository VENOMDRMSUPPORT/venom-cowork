...
export type CommandPaletteProps = {
  ...
  /** Optional â€” open a URL in the user's browser. Falls back to window.open. */
...
export function CommandPalette(props: CommandPaletteProps) {
  ...
  const rootItems = useMemo<PaletteItem[]>(() => [
    ...
    // Top-bar shortcuts â€” these used to be selectable via Cmd+K and were
    ...
    // plus every settings tab the user is likely to reach for.
    {
      ...
      action: () => {
        props.onClose();
        openUrl("https://venomcowork.dev/docs");
      },
    },
    {
      id: "open-feedback",
      ...
      action: () => {
        props.onClose();
        openUrl("https://venomcowork.dev/feedback");
      },
    },
    {
      id: "settings-skills",
