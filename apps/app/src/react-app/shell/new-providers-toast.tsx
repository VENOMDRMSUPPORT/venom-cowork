...
const SEEN_KEY = "venomcowork.seenProviderIds";
const PENDING_MODEL_PICKER_KEY = "venomcowork.pendingModelPickerProviderIds";
const NEW_PROVIDERS_TOAST_ID = "venomcowork-new-providers";

/** Custom event to request the model picker to open. */
export const openModelPickerEvent = "venomcowork-open-model-picker";
