    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <PageHeader className="mb-8 text-center">
          ...
          <PageDescription>
            Connect a model, then try a real task in chat so you can see VenomCowork work.
          </PageDescription>
        </PageHeader>
        ...
        <div className="space-y-3">
          <button
            ...
            onClick={onVenomCoworkModels}
          >
            <SparklesIcon className="mt-0.5 size-5 shrink-0 text-blue-10" />
            <div>
              <div className="text-sm font-medium text-foreground">
                Use VenomCowork Models
              </div>
              <div className="mt-0.5 text-xs text-muted-foreground">
                Pay through VenomCowork Cloud and skip API key setup.
              </div>
            </div>
          </button>
