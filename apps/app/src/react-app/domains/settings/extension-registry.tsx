...
export type ExtensionRuntimeContext = Pick<
  ...
  "venomcoworkServerClient" | "extensionConnections" | "onExtensionConnectionChange"
>;

export type VenomCoworkExtensionRuntime = {
  id: string;
...
const runtimeRegistry = new Map<string, VenomCoworkExtensionRuntime>();

export function registerExtensionConfig(id: string, factory: ExtensionConfigFactory) {
  registry.set(id, factory);
}

export function registerExtensionRuntime(runtime: VenomCoworkExtensionRuntime) {
