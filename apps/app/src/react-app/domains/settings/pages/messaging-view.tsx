        ...
        <div className="mb-1.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              disabled={props.busy || props.venomcoworkReconnectBusy}
            >
                                ...
                                >
                                  <div className="min-w-0">
                                    ...
                                    <div className="mt-0.5 pl-3.5 text-[11px] text-gray-9">
                                      {item.enabled ? t("identities.enabled_label") : t("identities.disabled_label")} Â· {item.running ? t("identities.running_label") : t("identities.stopped_label")} Â· {item.access === "private" ? t("identities.private_label") : t("identities.public_label")}
                                    </div>
                                  </div>
                                  <Button
                                    variant="outline"
                              ...
                              {props.slack.identities.map((item) => (
                                ...
                                >
                                  <div className="min-w-0">
                                    ...
                                    <div className="mt-0.5 pl-3.5 text-[11px] text-gray-9">
                                      {item.enabled ? t("identities.enabled_label") : t("identities.disabled_label")} Â· {item.running ? t("identities.running_label") : t("identities.stopped_label")}
                                    </div>
                                  </div>
                                  <Button
                                    variant="outline"
