...
interface CloudWorkerListItemProps {
  ...
  worker: CloudWorker;
  onVenomCoworker: (workerId: string, workerName: string) => void | Promise<void>;
}

function CloudWorkerListItem({ openingWorkerId, worker, onVenomCoworker }: CloudWorkerListItemProps) {
  ...
  return (
    <SettingsListItem>
      ...
      <Button
        variant="outline"
        size="sm"
        onClick={() => void onVenomCoworker(worker.workerId, worker.workerName)}
                    ...
                    <SettingsList>
                      {group.rows.map((worker) => (
                        <CloudWorkerListItem
                          ...
                          worker={worker}
                          onVenomCoworker={onVenomCoworker}
                        />
                      ))}
                    </SettingsList>
                  </AccordionContent>
