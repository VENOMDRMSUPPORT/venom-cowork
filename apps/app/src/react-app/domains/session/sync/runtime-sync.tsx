...
export function ReactSessionRuntime(props: ReactSessionRuntimeProps) {
  useEffect(() => {
    const input = {
      ...
      venomcoworkToken: props.venomcoworkToken,
  ...
  }, [props.workspaceId, props.sessionId, props.activeSessionIds, props.opencodeBaseUrl, props.venomcoworkToken, props.onSessionUpdated, props.onSessionStatus]);
