...
export function resolveRenderedSessionSnapshot(input: {
  sessionId: string;
  currentSnapshot: VenomcoworkSessionSnapshot | null | undefined;
  cachedRendered: { sessionId: string; snapshot: VenomcoworkSessionSnapshot } | null | undefined;
}) {
...
export function deriveRenderedSessionMessages(input: {
  ...
  snapshot: VenomcoworkSessionSnapshot | null | undefined;
}) {
