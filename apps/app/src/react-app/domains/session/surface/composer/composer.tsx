...
import { VENOMCOWORK_EXTENSION_CATALOG, type McpDirectoryInfo } from "@/app/constants";
import type { CloudImportedPlugin, CloudImportedPluginFile } from "@/app/cloud/import-state";
import type { ComposerAttachment, McpServerEntry, McpStatusMap, ModelRef, SkillCard, SlashCommandOption } from "@/app/types";
import { formatBytes } from "@/app/utils";
import { t } from "@/i18n";
import { isVenomCoworkExtensionEnabled, isVenomCoworkExtensionHidden, VENOMCOWORK_EXTENSION_STATE_CHANGED } from "@/react-app/domains/settings/extension-state";
...
function isComposerExtensionAvailable(entry: McpDirectoryInfo) {
  ...
  if (hasSessionSurface) return isVenomCoworkExtensionEnabled(entry);
  return !entry.defaultEnabled || isVenomCoworkExtensionEnabled(entry);
}
...
const FLUSH_PROMPT_EVENT = "venomcowork:flushPromptDraft";
const FOCUS_PROMPT_EVENT = "venomcowork:focusPrompt";
 ...
 * the text/uri-list MIME type explicitly. Plain text pastes â€” even ones that
 * contain absolute paths like "/Users/..." â€” are NEVER treated as links here
...
export function ReactSessionComposer(props: ComposerProps) {
  ...
  const activePlugin = toolMenuSection.startsWith("plugin:")
    ...
    : null;
  const composerExtensions = VENOMCOWORK_EXTENSION_CATALOG.filter((entry) =>
    !builtInExtensionsDisabled &&
    !isVenomCoworkExtensionHidden(entry) && isComposerExtensionAvailable(entry)
  );
  ...
  const handleKeyDownCapture: React.KeyboardEventHandler<HTMLDivElement> = (event) => {
    // IME composition guard â€” block Enter while IME is mid-character.
    const imeActive =
    ...
    >
      <div className="max-w-[800px] mx-auto">
        ...
        >
          ...
          {/*
            The pasted-text chip used to render twice â€” once inline inside
          ...
          <div className="px-4 pt-3 pb-2">
            ...
            <LexicalPromptEditor
              ...
              onPaste={(event) => {
                ...
                // editor. Do NOT duplicate that here â€” calling onPasteText
                ...
                if (
                  ...
                  // Intentionally no preventDefault â€” the notice is advisory,
            ...
            {/* Action row â€” attach/inbox/tools on the left, send on the right */}
            <div className="mt-2 flex items-end justify-between gap-2">
              ...
              {/*
                ...
                - Busy: follow-up controls â€” "Steer" sends now (the agent
        ...
        <div className="mt-1 flex items-center justify-between px-1">
          ...
          {/* Status label removed â€” redundant with the footer bar */}
        </div>
      </div>
    </div>
  );
