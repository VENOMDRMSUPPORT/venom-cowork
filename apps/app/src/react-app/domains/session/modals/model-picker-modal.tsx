...
export function ModelPickerModal(props: ModelPickerModalProps) {
  ...
  const [promoHidden, setPromoHidden] = useState(isVenomCoworkModelsPromoHidden);
  ...
  const showVenomCoworkModelsPromo = useMemo(
    () => !promoHidden && !hasVenomCoworkModelsProvider(props.options.map((option) => option.providerID)),
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          {showVenomCoworkModelsPromo ? (
            <div className="mb-3 flex shrink-0 items-center overflow-hidden rounded-2xl border border-blue-6/60 bg-blue-2/60 shadow-[0_12px_30px_-20px_rgba(var(--dls-accent-rgb),0.45)]">
              ...
              >
                <ProviderIcon providerId={VENOMCOWORK_MODELS_PROVIDER_ID} providerName={VENOMCOWORK_MODELS_PROVIDER_NAME} size={18} className="shrink-0 text-blue-11" />
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5 text-[13px] font-medium text-dls-text">
                    <Sparkles className="size-3.5 text-blue-11" />
                    <span>{VENOMCOWORK_MODELS_PROVIDER_NAME}</span>
                  </div>
              ...
              <button
                ...
                aria-label="Hide VenomCowork Models"
              >
