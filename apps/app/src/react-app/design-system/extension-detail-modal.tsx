...
const kindLabel: Record<ExtensionKind, string> = {
  ...
  extension: "VenomCowork Extension",
};
...
const kindDesc: Record<ExtensionKind, string> = {
  ...
  plugin: "Extends VenomCowork with additional capabilities managed by your organization.",
  skill: "A reusable workflow that your agent can execute on demand.",
  "ui-control": "Lets another MCP client inspect and drive this VenomCowork desktop UI through a local stdio wrapper.",
  extension: "An VenomCowork extension that adds tools, providers, or integrations to your workspace.",
};
...
const fallbackUiControlCommand = ["npx", "-y", "venomcowork-ui-mcp"];
      ...
      <Card variant="outline" size="sm">
        ...
        <CardContent>
          <div className="flex flex-col gap-2 text-sm leading-relaxed text-muted-foreground">
            <div>VenomCowork desktop starts a private localhost bridge automatically.</div>
            <div>Your MCP client starts <span className="font-mono text-card-foreground">venomcowork-ui-mcp</span> over stdio; the wrapper discovers the bridge and proxies UI tools to it.</div>
              ...
              <TableBody>
                <TableRow className="*:border-border hover:bg-transparent [&>:not(:last-child)]:border-r">
                  ...
                  <TableCell className="py-2 whitespace-normal">
                    <span className="font-mono text-xs break-all">~/Library/Application Support/com.venom.cowork/venomcowork-ui-control.json</span>
                  </TableCell>
                </TableRow>
                <TableRow className="*:border-border hover:bg-transparent [&>:not(:last-child)]:border-r">
                  ...
                  <TableCell className="py-2 whitespace-normal">
                    <span className="font-mono text-xs break-all">~/Library/Application Support/com.venom.cowork.dev/venomcowork-ui-control.json</span>
                  </TableCell>
                </TableRow>
                <TableRow className="*:border-border hover:bg-transparent [&>:not(:last-child)]:border-r">
                  <TableCell className="bg-muted/50 py-2 text-xs font-medium">
                  ...
                  <TableCell className="py-2 whitespace-normal">
                    <span className="font-mono text-xs break-all">VENOMCOWORK_UI_CONTROL_DISCOVERY=/path/to/venomcowork-ui-control.json</span>
                  </TableCell>
                </TableRow>
                {props.environment?.VENOMCOWORK_UI_CONTROL_DISCOVERY ? (
                  <TableRow className="*:border-border hover:bg-transparent [&>:not(:last-child)]:border-r">
                    <TableCell className="bg-muted/50 py-2 text-xs font-medium">
                      Current override
                    </TableCell>
                    <TableCell className="py-2 whitespace-normal">
                      <span className="font-mono text-xs break-all">{props.environment.VENOMCOWORK_UI_CONTROL_DISCOVERY}</span>
                    </TableCell>
                  </TableRow>
                ) : null}
              </TableBody>
