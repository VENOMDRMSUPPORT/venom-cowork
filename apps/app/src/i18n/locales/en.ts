...
export default {
  ...
  "settings.custom_binary_hint": "Use this to point VenomCowork at a local OpenCode build",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by VenomCowork. Off by default.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by VenomCowork.",
  ...
  "settings.venomcowork_config_sidecar_desc": "Local VenomCowork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  ...
  "settings.reset_venomcowork_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside venomcowork-dev-data.",
  "settings.reset_venomcowork_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside venomcowork-dev-data.",
  "settings.reset_venomcowork_title": "Reset VenomCowork + OpenCode state",
  ...
  "system.reload_body_default": "VenomCowork detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "VenomCowork detected OpenCode configuration changes. Reload the engine to apply them.",
