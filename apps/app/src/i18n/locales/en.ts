 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, VenomCowork Engine, VenomCowork) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "VenomCowork server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "VenomCowork server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.engine_reload_desc": "Restart the VenomCowork Engine server for this workspace.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected VenomCowork servers.",
  ...
  "config.server_needed_hint": "VenomCowork server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an VenomCowork server. Use the URL plus a collaborator or owner token from your server admin.",
  ...
  "config.server_sharing_title": "VenomCowork server sharing",
  "config.server_url_hint": "Use the URL shared by your VenomCowork server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "VenomCowork server URL",
  "config.server_url_label": "VenomCowork Server URL",
  "config.starting_server": "Starting serverâ€¦",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable VenomCowork server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "VenomCowork server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "VenomCowork server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "VenomCowork server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable VenomCowork server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted VenomCowork worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted VenomCowork worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an VenomCowork server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to VenomCowork Cloud to access workers shared with your organization.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the VenomCowork server details for this workspace.",
  ...
  "dashboard.importing": "Importingâ€¦",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted VenomCowork worker.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and VenomCowork will reconnect here automatically.",
  ...
  "den.cloud_provider_detail": "{count} models Â· {source} provider",
  "den.cloud_provider_removed_detail": "This imported provider is no longer in cloud. Uninstall the local {providerId} config.",
  "den.cloud_provider_sync_detail": "Cloud provider changed. Sync the {count} model {source} config into venomcowork.jsonc.",
  "den.cloud_skill_detail": "Install this cloud skill into .venomcowork/skills.",
  ...
  "den.cloud_providers_hint": "Import managed LLM providers into venomcowork.jsonc and use the org credential in this workspace.",
  ...
  "den.cloud_sleep_hint": "Sign in to VenomCowork Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use VenomCowork Cloud.",
  "den.cloud_workers_hint": "Open workers directly into VenomCowork using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but VenomCowork Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in VenomCowork.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid VenomCowork sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete VenomCowork Cloud sign-in.",
  ...
  "den.signin_code_note": "Accepts an venomcowork://den-auth link or the raw one-time grant.",
  "den.signin_link_hint": "If your browser doesn't bounce back into VenomCowork automatically, paste the sign-in link or one-time code from VenomCowork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "venomcowork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to VenomCowork Cloud",
  "den.signing_in": "Finishing VenomCowork Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.skill_hub_detail": "Import {count} shared skills into .venomcowork/skills.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect VenomCowork.",
  "den.status_browser_signup": "Finish account creation in your browser to connect VenomCowork.",
  "den.status_cloud_signed_in_as": "Connected VenomCowork Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected VenomCowork Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in VenomCowork.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your VenomCowork Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "extensions.subtitle": "Apps (MCP) and VenomCowork Engine plugins live in one place.",
  "extensions.title": "Extensions",
  "identities.agent_behavior_desc": "One file per workspace. Add optional first line @agent <id> to route via a specific VenomCowork Engine agent.",
  ...
  "identities.agent_loading": "Loading agent fileâ€¦",
  ...
  "identities.agent_scope_status": "Active scope: workspace Â· status: {status} Â· selected agent: {agent}",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an VenomCowork host.",
  "identities.connect_server_title": "Connect to an VenomCowork server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check VenomCowork URL/token and try again.",
  ...
  "mcp.reloading_status": "Reloading MCP serversâ€¦",
  "mcp.toggle_failed": "Failed to update MCP enabled state.",
  "mcp.toggle_requires_server": "Connect to an VenomCowork server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so VenomCowork can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.oauth_not_supported_hint": "This could mean:\nâ€¢ The MCP server doesn't advertise OAuth capabilities\nâ€¢ The engine needs to reload to discover server capabilities\nâ€¢ Try: venomcowork mcp auth {server} from the CLI",
  ...
  "mcp.auth.reauth_cli_hint": "Run: venomcowork mcp auth {server}",
  ...
  "mcp.auth.reload_notice": "For this to take effect, VenomCowork needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, VenomCowork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize VenomCowork",
  ...
  "mcp.connection_failed": "Connection issue â€” try again",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from VenomCowork.",
  ...
  "mcp.quick_connect_venomcowork_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_venomcowork_cloud_title": "VenomCowork Cloud Control",
  "mcp.quick_connect_venomcowork_ui_desc": "Let agents see and drive the VenomCowork app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_venomcowork_ui_title": "VenomCowork UI Control",
  ...
  "welcome.title": "Welcome to VenomCowork",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. VenomCowork will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and VenomCowork can pick them up.",
  "plugins.add": "Add",
  "plugins.add_hint": "Add npm package names, e.g. venomcowork-wakatime",
  "plugins.add_label": "Add plugin",
  "plugins.added": "Added",
  "plugins.config": "Config",
  "plugins.config_label": "Config",
  "plugins.desc": "Manage `venomcowork.json` for your project or global VenomCowork Engine plugins.",
  ...
  "providers.disabled_in_config_suffix": "and disabled it in VenomCowork Engine config.",
  ...
  "session.doom_loop_message": "VenomCowork Engine detected repeated tool calls with identical input and is asking whether it should continue after repeated failures.",
  ...
  "session.palette_hint_run": "Enter to run Â· Esc to close",
  ...
  "session.permission_message": "VenomCowork Engine is requesting permission to continue.",
  "session.permission_message_bash": "Review the command scope before allowing VenomCowork Engine to continue.",
  "session.permission_message_edit": "Review the file and diff before allowing VenomCowork Engine to make changes.",
  ...
  "session.share_local_host_not_ready": "Local VenomCowork host is not ready yet.",
  "session.share_missing_host_url": "Missing VenomCowork host URL.",
  "session.share_missing_token": "Missing VenomCowork token.",
  ...
  "session.share_opencode_base_url": "VenomCowork Engine base URL",
  "session.share_venomcowork_workers_only": "Share service links are available for VenomCowork workers.",
  ...
  "settings.api_keys_info": "API keys are stored locally by VenomCowork Engine. Environment-backed providers must be changed in the worker environment and then reloaded.",
  ...
  "settings.auto_compact_desc": "Controls VenomCowork Engine compaction.auto for this workspace. Reload the engine after changing it.",
  ...
  "settings.capabilities_title": "VenomCowork server capabilities",
  "settings.capabilities_unavailable": "Capabilities unavailable. Connect with a client token.",
  "settings.change": "Change",
  "settings.choose": "Choose",
  "settings.clear": "Clear",
  "settings.config_updated": "Configuration updated. Reload the engine if the change affects VenomCowork Engine.",
  ...
  "settings.custom_binary_hint": "Use this to point VenomCowork at a local VenomCowork Engine build",
  "settings.custom_binary_label": "Custom VenomCowork Engine binary",
  ...
  "settings.deeplink_hint": "Accepts venomcowork:// or venomcowork-dev:// links.",
  ...
  "settings.enable_exa_desc": "Applies the next time VenomCowork Engine is started by VenomCowork. Off by default.",
  ...
  "settings.engine_desc": "Choose how VenomCowork Engine runs locally.",
  ...
  "settings.exa_restart_hint": "Restart VenomCowork Engine after changing this setting.",
  ...
  "settings.feedback_title": "Help shape VenomCowork",
  ...
  "settings.nuke_hint": "Use this only when you want to fully reset the desktop app and its VenomCowork Engine runtime state.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an VenomCowork deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_label": "VenomCowork Engine",
  "settings.opencode_engine_sidecar": "VenomCowork Engine",
  "settings.opencode_engine_sidecar_desc": "Local VenomCowork Engine process managed by VenomCowork.",
  "settings.opencode_sdk_desc": "Browser â†’ engine connection.",
  "settings.opencode_sdk_title": "VenomCowork Engine SDK link",
  "settings.opencode_section_label": "VenomCowork Engine",
  "settings.opening": "Open deeplink",
  "settings.venomcowork_config_sidecar_desc": "Local VenomCowork server (Bun) that hosts approvals, audit, and VenomCowork Engine lifecycle.",
  "settings.venomcowork_diagnostics_title": "VenomCowork server diagnostics",
  "settings.venomcowork_server_desc": "Session control plane for app sync, workers, and remote",
  ...
  "settings.quit_hint": "VenomCowork quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect VenomCowork server.",
  "settings.reconnected": "Reconnected to VenomCowork server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears VenomCowork cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears VenomCowork cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. VenomCowork will restart.",
  ...
  "settings.reset_onboarding_description": "Clears VenomCowork preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears VenomCowork local preferences and workspace onboarding markers.",
  "settings.reset_venomcowork_desc_dev": "With dev mode active, it only clears the isolated VenomCowork Engine dev state inside venomcowork-dev-data.",
  "settings.reset_venomcowork_desc_prod": "With dev mode active, it only clears the isolated VenomCowork Engine dev state inside venomcowork-dev-data.",
  "settings.reset_venomcowork_title": "Reset VenomCowork + VenomCowork Engine state",
  ...
  "settings.restart_blocked_message": "The update is ready, but VenomCowork will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart VenomCowork Engine",
  "settings.restart_venomcowork_server": "Restart VenomCowork server",
  "settings.restart_server_failed": "Failed to restart local server.",
  "settings.restarted": "Restarted local server.",
  "settings.restarting": "Restartingâ€¦",
  ...
  "settings.services_section_desc": "Local services that power this VenomCowork session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting VenomCowork.",
  ...
  "settings.runtime_desc": "Status for your local engine and VenomCowork server.",
  ...
  "settings.search_models": "Search modelsâ€¦",
  ...
  "settings.tab_description_appearance": "Adjust how VenomCowork looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_extensions": "Manage MCP apps and VenomCowork Engine plugins for this workspace.",
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected VenomCowork workspace plus its runtime connection.",
  ...
  "settings.update_checking": "Checking for updatesâ€¦",
  "settings.update_download_button": "Download",
  "settings.update_downloading": "Downloading updateâ€¦",
  ...
  "settings.updates_desc": "Keep VenomCowork up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an VenomCowork host, then choose it from the list to import this skill.",
  ...
  "skills.add_venomcowork_hub": "Add VenomCowork Hub",
  ...
  "skills.cloud_choose_org_hint": "Choose an organization in Settings â†’ Cloud to load team skills.",
  ...
  "skills.cloud_installing": "Installing {title}â€¦",
  ...
  "skills.cloud_section_subtitle": "Skills shared with you through VenomCowork Cloud â€” including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to VenomCowork Cloud to browse team and org skills.",
  ...
  "skills.cloud_updating": "Updating {title}â€¦",
  ...
  "skills.failed_load_opencode": "Failed to load venomcowork.json",
  "skills.failed_parse_opencode": "Failed to parse venomcowork.json",
  "skills.failed_to_load": "Failed to load skills",
  "skills.failed_update_opencode": "Failed to update venomcowork.json",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected VenomCowork server.",
  ...
  "skills.installing_prefix": "Installing {name}â€¦",
  "skills.installing_skill_creator": "Installing skill creator...",
  "skills.loading": "Loadingâ€¦",
  ...
  "skills.no_opencode_found": "No venomcowork.json found yet. Add a plugin to create one.",
  "skills.no_opencode_workspace": "No venomcowork.json in this workspace yet.",
  "skills.no_skills": "No skills detected in `.venomcowork/skills`, `.claude/skills`, or `~/.agents/skills`.",
  ...
  "skills.plugin_already_listed": "Plugin already listed in venomcowork.json.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active VenomCowork Cloud organization.",
  "skills.share_option_team_title": "Share with team",
  "skills.share_subtitle_team": "Stored in your organization for teammates.",
  "skills.share_team_choose_org": "Choose an organization in Settings â†’ Cloud before sharing with your team.",
  "skills.share_team_permissions_intro": "Upload this skill to your active VenomCowork Cloud organization and decide who can see it.",
  ...
  "skills.share_team_hubs_loading": "Loading hubsâ€¦",
  "skills.share_team_org_fallback": "Active Cloud org",
  "skills.share_team_upload_and_save": "Upload and save",
  "skills.share_team_uploading": "Uploadingâ€¦",
  "skills.share_team_sign_in": "Sign in to share with team",
  "skills.share_team_sign_in_hint": "VenomCowork Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full VenomCowork features",
  "status.limited_mcp_hint": "{count} MCP connected Â· reconnect for full features",
  ...
  "status.venomcowork_ready": "VenomCowork Ready",
  ...
  "system.reload_body_agents": "VenomCowork Engine loads agents at startup. Reload the engine to make updated agents available.",
  "system.reload_body_commands": "VenomCowork Engine loads commands at startup. Reload the engine to make updated commands available.",
  "system.reload_body_config": "VenomCowork Engine reads venomcowork.json at startup. Reload the engine to apply configuration changes.",
  "system.reload_body_default": "VenomCowork detected changes that require reloading the VenomCowork Engine instance.",
  "system.reload_body_mcp": "VenomCowork Engine loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "VenomCowork detected VenomCowork Engine configuration changes. Reload the engine to apply them.",
  "system.reload_body_plugins": "VenomCowork Engine loads npm plugins at startup. Reload the engine to apply venomcowork.json changes.",
  "system.reload_body_skills": "VenomCowork Engine can cache skill discovery/state. Reload the engine to make newly installed skills available.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "VenomCowork can't load tasks from this worker until the connection is fixed.",
