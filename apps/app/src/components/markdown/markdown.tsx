...
const highlightedMarkdownParser = new Marked({
  ...
  markedShiki({
    ...
    container: `<div data-venomcowork-shiki="true" class="my-4 overflow-hidden rounded-lg border border-border/70 bg-gray-1/80 p-4 text-xs leading-6">%s</div>`,
  }),
);
