...
description: "Create a custom provider definition in VenomCowork Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in VenomCowork Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
```json
{
  ...
  "doc": "https://infron.ai/docs/frameworks-and-integrations/venomcowork",
...
<Frame>
  ![DeepSeek V3.2 via Infron in the VenomCowork Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron Â· DeepSeek V3.2 selected in an VenomCowork session](/images/infron-model-active.png)
</Frame>
