...
description: "Create reusable workspace templates for teams in VenomCowork Cloud"
---
...
1. Build the workspace locally in the VenomCowork desktop app.
2. Add the skills, MCP servers, commands, agents, and providers the team should start with.
3. Share the setup to your VenomCowork Cloud organization.
