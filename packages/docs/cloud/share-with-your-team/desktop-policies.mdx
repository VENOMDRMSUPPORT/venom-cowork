...
- `Built-in Extensions`: allow or block VenomCowork-provided built-in extensions, including browser, image, and local-provider extensions.
- `Welcome Page`: show or hide the getting-started page for new users.

## Configure a policy

1. Open [app.venomcowork.local](https://app.venomcowork.local/) and choose your organization.
