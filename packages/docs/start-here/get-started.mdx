...
Most people should start with the [VenomCowork app](https://venomcowork.local/download). It lets you use any LLM, skill, and plugin locally, then share that setup with your team when you are ready.
...
<CardGroup cols={3}>
  ...
  <Card title="Control the browser" icon="globe" href="/start-here/do-work-with-it/control-the-browser">
    Let VenomCowork run and screenshot tasks in Chrome for you.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Download VenomCowork" icon="download" href="https://venomcowork.local/download">
    Start with the desktop app, connect providers, add MCP servers, and run tasks right away.
  </Card>
  <Card title="VenomCowork Cloud" icon="users" href="/cloud/get-started">
...
[GitHub](https://github.com/venom-cowork/workspace) Â· [Changelog](/changelog) Â· [Product Roadmap](/roadmap) Â· [Missing docs](/start-here/missing-docs) Â· [Missing languages](/start-here/missing-languages)
