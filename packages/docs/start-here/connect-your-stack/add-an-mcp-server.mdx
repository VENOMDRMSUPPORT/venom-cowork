...
description: "How to connect a custom MCP server with venomcowork"
---

Connecting a custom MCP server with venomcowork takes four clicks.
...
Once in their Oath page, you should just continue with the registration or custom setup. It should redirect back to venomcowork. Feel free to [open an issue](https://github.com/venom-cowork/workspace/issues/) if you require a custom MCP that we currently do not support.
