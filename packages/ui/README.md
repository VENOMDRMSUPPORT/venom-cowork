...
Shared UI primitives for VenomCowork apps.

This package intentionally ships two framework-specific entrypoints:

- `@venom-cowork/ui/react` for React apps like `ee/apps/den-web`
- `@venom-cowork/ui/solid` for Solid apps like `apps/app`
...
The first shared components live under the `paper` namespace and wrap Paper Design shaders with VenomCowork-specific defaults and deterministic seed support.
