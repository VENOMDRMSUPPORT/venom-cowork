...
export function FeedbackEmail({
  ...
  const metadata = [
    ...
    ["VenomCowork server", venomcoworkServerVersion],
  ...
  return (
    <Html>
      <Head />
      <Preview>{name} sent VenomCowork feedback from {entrypoint || source || "unknown"}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>VenomCowork feedback</Text>
