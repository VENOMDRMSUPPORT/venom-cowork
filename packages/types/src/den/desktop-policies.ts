...
export const desktopPolicyDefinitions = [
  {
    ...
    description:
      "Allow users to add and use models that are not deployed through VenomCowork Cloud.",
    userNotice:
  ...
  },
  {
    ...
    description:
      "Allow users to see and use VenomCowork's built-in extensions, including browser, image, and local-provider extensions.",
    userNotice:
      "Your organization administrator has disabled built-in VenomCowork extensions.",
    defaultValue: true,
  },
  {
    id: "showWelcomePage",
